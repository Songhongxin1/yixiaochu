...
$(function(){
    ...
    var listeners = {
        ...
        uploadSuccess: function(event, file, serverData){
            ...
            }else if(this.id == 'uploader_head_img'){
                var name = 'head_img';
            }
    ...
    $('#uploader_book_img').bindAll(listeners);
    ...
    $('#uploader_head_img').bindAll(listeners);
});

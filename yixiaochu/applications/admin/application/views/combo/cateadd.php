...
<div class="formbody">
	...
	<ul class="forminfo">
		<li><label>分类名称</label><input type="text" id="name" name="name" class="dfinput" /><i><b>*</b></i></li>
		<li><label>排序</label><input type="text" id="sort" name="sort" value="0" class="dfinput" /><i><b>*</b></i></li>
		<li><label>状态&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" id="is_del" checked name="is_del" value='0' />显示</label>&nbsp;&nbsp;<label><input type="radio" id="is_del" name="is_del" value='1' />不显示</li>
    ...
    $(function(){
    	$('.btn').click(function(){
    		...
    		if(name == ''){
				...
				//检测通过
				$.post('/combo/cateadd', {'name': name, 'sort': sort, 'is_del': is_del}, function(data){
					if(data.code==1){
						dialog({
							id: 'GSDF',
							title: '系统提示信息',

...
<div class="rightinfo">
    <div class="tools">
        <ul class="toolbar">
            ...
            <li class="batch-publish"><span><img src="<?php echo $domain['static']['url'];?>/admin/images/t02.png"></span>批量发布</li>
        </ul>
    </div>
    <div class="tools">
        <form method="get">
    ...
    <table class="tablelist">
        ...
        <tbody>
            ...
            <tr <?php if($key%2 !=0 ){ echo 'class="odd"';}?>>
                ...
                <td><?php echo $val['agency'];?></td>
                <td><?php echo $news_class[$val['news_class_id']];?></td>
                <td><?php echo $val['is_head_recommend'] == 1 ? '推荐' : '不推荐';?></td>
                <td><?php echo $val['is_news_recommend'] == 1 ? '推荐' : '不推荐';?></td>
                <td><?php echo $val['is_banner_recommend'] == 1 ? '推荐' : '不推荐';?></td>
                <td><?php echo $val['is_hot'] == 1 ? '是' : '否';?></td>
                <td><?php echo $val['is_del'] == 1 ? '<span style="color:red">已删除</span>' : '未删除';?></td>
                <td><?php echo $val['publish_status'] == 1 ? '<span style="color:green">已发布</span>' : '<span style="color:red">未发布</span>';?></td>
                ...
                <td>
                    ...
                    <?php if($val['publish_status'] == 0):?>
                    <a href="/news/update_status/<?php echo $val['id'];?>/1" class="tablelink">确认发布</a>
                    <?php else:?>
                    <a href="/news/update_status/<?php echo $val['id'];?>/0" class="tablelink">取消发布</a>
                    <?php endif;?>
                </td>
            </tr> 
            <?php endforeach;?>

...
<div class="formbody">
    ...
    <form action="" method="post" >
        <ul class="forminfo">
            ...
            <li><label>视频链接<b></b></label><input type="text" name="video_url" class="dfinput" value="<?php echo $info['video_url']?>"/></li>
            <li>
                <label>封面图<b>*</b></label>
                <ul id="uploader_cover_img">
                    ...
                    <li class='pic pro_gre' style='margin-right: 20px; clear:none;'>
                        ...
                        <a href="<?php echo get_full_img_url($info['cover_img']);?>" target="_blank"><img src="<?php echo get_full_img_url($info['cover_img']);?>" style='width:100%;height:100%'/></a>
            ...
            <li>
                <label>官网首页推荐</label>
                <cite>
                    <input name="is_head_recommend" type="radio" value="1" <?php if($info['is_head_recommend'] == 1){ echo "checked='checked'"; }?> />是
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="is_head_recommend" type="radio" value="0" <?php if($info['is_head_recommend'] == 0){ echo "checked='checked'"; }?> />否
                </cite>
            </li>
            <li>
                <label>资讯首页推荐</label>
                <cite>
                    <input name="is_news_recommend" type="radio" value="1" <?php if($info['is_news_recommend'] == 1){ echo "checked='checked'"; }?> />是
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="is_news_recommend" type="radio" value="0" <?php if($info['is_news_recommend'] == 0){ echo "checked='checked'"; }?> />否
                </cite>
            </li>
            <li>
                <label>banner推荐</label>
                <cite>
                    <input name="is_banner_recommend" type="radio" value="1" <?php if($info['is_banner_recommend'] == 1){ echo "checked='checked'"; }?> />是
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="is_banner_recommend" type="radio" value="0" <?php if($info['is_banner_recommend'] == 0){ echo "checked='checked'"; }?> />否
                </cite>
            </li>
            <li>
                <label>是否热门</label>
                <cite>
                    <input name="is_hot" type="radio" value="1" <?php if($info['is_hot'] == 1){ echo "checked='checked'"; }?> />是
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="is_hot" type="radio" value="0" <?php if($info['is_hot'] == 0){ echo "checked='checked'"; }?> />否
                </cite>
            </li>
            <li>
                <label>发布时间</label>
